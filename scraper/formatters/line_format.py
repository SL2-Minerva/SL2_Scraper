...
import scraper.formatters.data_format as dataFormat
import psutil
...
def format_campaign_result(platform="", campaign_name="", campaign_id=0, keyword="", datetime_start_campaign_scraping=datetime.now(), datetime_end_campaign_scraping=datetime.now(), total_result=""):
